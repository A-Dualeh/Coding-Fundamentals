// Program to create a List of Tasks, allowing user to add, remove and view the list (learning points: List,Objects, switch)
        ...
        while (true)
        {
            ...
            switch (selection)
            {
                case "1":
                    ...
                    Console.WriteLine("Enter task due-date (e.g. 07-10-2023): ");
